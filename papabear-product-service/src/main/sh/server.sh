...
APP_NAME="papabear-product-service"
#JAVA虚拟机参数设置
...
start(){
 ...
 showprogress
 JAVA_OPTS="$JAVA_OPTS "
 #exec $JAVA $JAVA_OPTS -Djava.ext.dirs=./  -jar papabear-product-service.jar &
 nohup $JAVA $JAVA_OPTS -Djava.ext.dirs=./  -jar papabear-product-service.jar > stdout.log 2>&1 &
